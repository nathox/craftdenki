		...
		<s:form id="form_1" action="DestinationChangeAction">
			...
			<s:iterator value="list_user_info">
				...
				<table>
					...
					<tr>
						<th>郵便番号</th>
						<td>〒<input type="text" name="yuubin1" size="4" maxlength="3"
							onkeyup="nextField(this, 'yuubin4', 3)">-<input
					...
					<tr>
						<th>郵便番号</th>
						<td>〒<input type="text" name="yuubin2" size="4" maxlength="3"
							onkeyup="nextField(this, 'yuubin5', 3)">-<input
					...
					<tr>
						<th>郵便番号</th>
						<td>〒<input type="text" name="yuubin3" size="4" maxlength="3"
							onkeyup="nextField(this, 'yuubin6', 3)">-<input
