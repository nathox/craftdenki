...
<div class="bar">
	...
	<s:if test="session.trueID == null">
		<a href='<s:url action="GoLoginAction" />' class="button">ログイン</a>
	</s:if>
	<s:else>
		<a href='<s:url action="LogoutAction" />' class="button">ログアウト</a>
	</s:else>


	<a href='<s:url action="GoMyPageAction" />' class="button">マイページ</a>

	<a href='<s:url action="GoCartAction" />' class="button">カート</a>

	<a href='<s:url action="ProductListAction" />' class="button">商品一覧</a>
