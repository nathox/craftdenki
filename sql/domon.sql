...
INSERT INTO product_info(product_id,product_name,product_name_kana,product_description,category_id,price,image_file_path,image_file_name,release_data,release_company,status,regist_date,update_date,item_stock) VALUES(6,"aaa","aaa","aaa",2,100,"aaa","aaa","2017/12/12","aaa",1,"2017/12/12","2017/12/12",500);
INSERT INTO product_info(product_id,product_name,product_name_kana,product_description,category_id,price,image_file_path,image_file_name,release_data,release_company,status,regist_date,update_date,item_stock) VALUES(7,"bbb","bbb","bbb",3,200,"bbb","bbb","2017/12/13","bbb",1,"2017/12/13","2017/12/13",500);